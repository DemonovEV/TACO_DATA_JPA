...
public class DesignTacoControllerTest {
    ...
    public void setup() {
        ...
        design.setIngredients(
                Arrays.asList(
                        new IngredientRef("FLTO"),// new Ingredient("FLTO", "Flour Tortilla", Type.WRAP),
                        new IngredientRef("GRBF"),// new Ingredient("GRBF", "Ground Beef", Type.PROTEIN),
                        new IngredientRef("CHED")//  new Ingredient("CHED", "Cheddar", Type.CHEESE)));
                ));
    }
